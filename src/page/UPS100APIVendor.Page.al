page 50005 "UPS100APIVendor"
{
    ...
    DelayedInsert = true;
    EntityName = 'upsVendor';
    EntitySetName = 'upsVendors';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(customerNo; Rec."CAI Customer No.")
                {
                }
                field(refiner; Rec."CAI Refiner")
                {
                }
                field(refiningCustomer; Rec."CAI Refining Customer")
                {
                }
                field(PMCSNetToPool; Rec."CAI PMCS Net to Pool")
                {
                }
